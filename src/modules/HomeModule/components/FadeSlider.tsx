      ...
      <Slider {...settings}>
        {SLIDER_DATA?.map((e, key) => (
          <Box my={{md:35,sm:20,xs:20}} key={key}>
            <Typography variant="h4" fontSize={{md:'24px',sm:'18px',xs:'16px'}} color={COLORS.primary.main} letterSpacing={1}>Hello World!</Typography>
            <Typography variant="h1" fontSize={{md:'60px',sm:'40px',xs:'25px'}} lineHeight={{md:"100px",sm:'60px',xs:'30px'}} letterSpacing={1}>
              I a'm
